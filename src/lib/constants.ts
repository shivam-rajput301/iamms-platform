...
> = {
  pending: {
    label: "Pending",
    color: "text-steel-700 dark:text-steel-300",
    bg: "bg-steel-100 dark:bg-steel-800",
    dot: "bg-steel-400",
  },
  assigned: {
    label: "Assigned",
  ...
  closed: {
    label: "Closed",
    color: "text-steel-600 dark:text-steel-400",
    bg: "bg-steel-100 dark:bg-steel-800",
    dot: "bg-steel-400",
  },
};
